...
//  const handleFocus = (field: any) => setFocused(prev => ({ ...prev, [field]: true }));
//  const handleBlur = (field: any) => {
//   if (!formData[field as keyof typeof formData]) setFocused(prev => ({ ...prev, [field]: false }));
// };

//   // الألوان المستخرجة من الصورة:
//   // البني الداكن: #775F4B | البيج المتوسط: #AF937A | البيج الفاتح: #E9DED4
